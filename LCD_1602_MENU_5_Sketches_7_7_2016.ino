...
//******************************************************************************************************************
/* by John Poston 7/7/2016 
 
 This version has only one Function pasted into this program: menuOne led scan
 
 A video of this in operation on youtube at: https://youtu.be/3Q2iRKjtHXA
...
String revLevB = "5_Sketches_7_7_2016";
//*************************************************STRINGS**********************************************************
String menu="Menu = ";
...
void mainMenu(){
  ...
  case 1:
    ...
    lcd.print("#1 ---Example---");//menuXxx function also displays the address on the serial monitor
...
/* ***************************************----- CONNECTIONS ----****************************************************
 ...
 4 Button Keypad shield inserted into the sensor shield in pins 9,10,11, and the common of the led shield goes to ground.
